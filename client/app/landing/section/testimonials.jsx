    ...
    <div className="flex flex-col md:flex-row p-8 gap-8 max-w-7xl mx-auto">
      ...
      <div className="md:w-1/3 sticky top-10 self-start">
        ...
        <p className="text-gray-600">
          Our clients’ success stories reflect our commitment to excellence. See how we’ve helped
          them find their dream homes, sustainable investments, and perfect getaways.
        </p>
      </div>
      ...
      <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
        {testimonials.map((t, i) => (
          ...
          >
            <div className="flex gap-1 text-yellow-400 mb-2">{'★'.repeat(t.stars)}</div>
