      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6">
            We specialize in luxury properties, sustainable homes, and vacation rentals — driven by
            a passion for exceptional living and a commitment to quality, innovation, and client
            satisfaction.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
        ...
        <div className="bg-gray-100 p-6 rounded-xl shadow-sm">
          ...
          <p className="text-gray-600 text-sm">
            ...
            sustainability, and vacation properties.
          </p>
        </div>
        ...
        <div className="bg-gray-100 p-6 rounded-xl shadow-sm">
          ...
          <p className="text-gray-600 text-sm">
            To create exceptional living experiences through innovation, sustainability, and
            personalized service in modern real estate.
          </p>
        </div>
      </div>
    </div>
