...
const ContactForm = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://images.unsplash.com/photo-1706808849780-7a04fbac83ef?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
      }}
    >
      ...
      <p className="mt-4 max-w-xl text-center text-lg font-light">
        ...
        invest, our team is here to guide you every step of the way. Let's turn your property goals
        into reality.
      </p>
      ...
      <form className="bg-white text-black rounded-2xl p-8 mt-8 w-full max-w-3xl shadow-lg">
        ...
        ></textarea>
        <button type="submit" className="w-full mt-4 bg-black text-white py-3 rounded-full">
          Book a Call
        </button>
      </form>
    </div>
