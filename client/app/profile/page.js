                  ...
                  {savedProperties.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 text-sm mt-2">
                        Browse properties and save your favorites for investment.
                      </p>
                      <Link
                        href="/properties"
                        className="inline-block mt-4 px-4 py-2 bg-black text-white rounded-full text-sm hover:bg-gray-900 transition-colors"
                      >
                        Browse Properties
                      </Link>
                    </div>
