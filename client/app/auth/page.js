  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="flex items-center justify-between py-3 px-8 md:px-12 lg:px-16">
        ...
        <Link href="/properties" className="text-sm text-gray-500 hover:text-black">
          Browse Properties
        </Link>
      </nav>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch">
        ...
        <div className="flex items-center justify-center px-6 md:px-12 lg:px-16 py-10">
          <div
            className={`w-full max-w-lg bg-white/90 backdrop-blur border border-gray-200 rounded-2xl shadow-sm p-6 md:p-8 transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}
          >
            {/* Toggle */}
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-1">
                Sign {mode === 'login' ? 'in' : 'up'} to continue your property journey.
              </p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="grid grid-cols-4 gap-1">
                      {[0, 1, 2, 3].map((i) => (
                        <div
                          key={i}
                          className={`h-1.5 rounded ${getPasswordStrength(form.password).score > i ? getPasswordStrength(form.password).color : 'bg-gray-200'}`}
                        />
                      ))}
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  disabled
                  className="border border-gray-300 rounded-lg py-2 text-sm text-gray-700 disabled:opacity-70 flex items-center justify-center gap-2"
                >
        ...
        <div className="relative hidden lg:block">
          ...
          <div className="relative h-full w-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-12">
              <div className="inline-block bg-white/90 text-black px-4 py-2 rounded-full text-sm mb-4 border">
                Your next move
              </div>
              <h3 className="text-3xl font-bold text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.4)]">
                Find your dream home
              </h3>
              <p className="text-white/90 mt-2 max-w-md">
                Discover homes tailored to your lifestyle and needs. Join ESTATES to unlock
            ...
            <div
              className={`absolute top-8 right-8 bg-white/90 backdrop-blur border border-gray-200 rounded-xl shadow p-4 w-56 transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-1'}`}
            >
              ...
              <p className="text-xs text-gray-700 mt-2 leading-relaxed">
                Trusted by <span className="font-semibold">5,000+ buyers</span> and investors. Rated{' '}
